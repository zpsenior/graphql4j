...
public class ScalarType extends Type implements Input {
	...
	public Class<?> getBaseClass()throws Exception {
		String clsName;
	...
	private Object parseChar(Object value)throws Exception{
